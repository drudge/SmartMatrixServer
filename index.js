...
function render(name, config) {
    return new Promise(async (resolve, reject) => {
        ...
        const renderCommand = spawn(`${__dirname}/pixlet/${process.platform}_${process.arch}/pixlet`, ['render', `${APPLET_FOLDER}/${name}/${name}.tmp.star`,...configValues,'-o',`${APPLET_FOLDER}/${name}/${name}.webp`]);
